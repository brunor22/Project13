...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── Detail panel ── */
  .detail-panel { display: none; position: fixed; right: 0; top: 0; width: 360px; height: 100vh; background: var(--surface); border-left: 1px solid var(--border); overflow-y: auto; z-index: 100; padding: 20px; box-shadow: -4px 0 24px rgba(0,0,0,0.5); }
  ...
  .detail-ticker { font-size: 24px; font-weight: 800; color: var(--blue); margin-top: 8px; }
  .detail-company { color: var(--muted); font-size: 13px; margin-bottom: 16px; }
...
function showDetail(ticker) {
  ...
  document.getElementById("detail-content").innerHTML = `
    ...
    <div style="margin-bottom:16px">${fmtVerdict(s.verdict)} &nbsp; ${fmtComposite(s.composite)}</div>
